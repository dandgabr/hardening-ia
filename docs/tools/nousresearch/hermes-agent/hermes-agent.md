...
Declarative policy file: [`configs/tools/nousresearch/hermes-agent/hardening_policy.yaml`](file:///B:/Code/hardening-ia/configs/tools/nousresearch/hermes-agent/hardening_policy.yaml)
